...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1353: (x0,x1) => x0.append(x1),
      _1354: x0 => x0.getVideoTracks(),
      _1355: x0 => x0.getSupportedConstraints(),
      _1356: x0 => ({video: x0}),
      _1357: x0 => ({facingMode: x0}),
      _1358: (x0,x1) => x0.getUserMedia(x1),
      _1359: x0 => ({type: x0}),
      _1360: (x0,x1) => new Blob(x0,x1),
      _1361: x0 => globalThis.URL.createObjectURL(x0),
      _1362: (x0,x1) => x0.getElementById(x1),
      _1363: (x0,x1) => x0.createElement(x1),
      _1364: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      _1369: x0 => x0.click(),
      _1370: () => ({}),
      _1371: x0 => globalThis.pdfjsLib.getDocument(x0),
      _1372: (x0,x1) => x0.getContext(x1),
      _1373: (x0,x1) => x0.getPage(x1),
      _1374: (x0,x1) => x0.getViewport(x1),
      _1375: (x0,x1) => x0.render(x1),
      _1376: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1376(f,arguments.length,x0) }),
      _1377: (x0,x1) => x0.toBlob(x1),
      _1378: () => new FileReader(),
      _1379: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1380: x0 => x0.cleanup(),
      _1381: x0 => x0.destroy(),
      _1382: (x0,x1) => { x0.module = x1 },
      _1383: (x0,x1) => { x0.exports = x1 },
      ...
      _1394: (x0,x1) => x0.replaceChildren(x1),
      ...
      _1404: (x0,x1) => x0.end(x1),
      _1405: x0 => x0.load(),
      _1406: (x0,x1) => x0.removeAttribute(x1),
      _1407: (x0,x1) => x0.setSinkId(x1),
      _1408: x0 => x0.decode(),
      ...
      _1424: x0 => new Blob(x0),
      _1427: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1428: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1429: x0 => globalThis.firebase_core.getApp(x0),
      _1430: () => globalThis.firebase_core.getApp(),
      _1431: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1433: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1435: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1437: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1438: (x0,x1) => ({next: x0,error: x1}),
      _1441: x0 => ({vapidKey: x0}),
      _1443: x0 => x0.title,
      _1444: x0 => x0.body,
      _1445: x0 => x0.image,
      _1446: x0 => x0.messageId,
      _1447: x0 => x0.collapseKey,
      _1448: x0 => x0.fcmOptions,
      _1449: x0 => x0.notification,
      _1450: x0 => x0.data,
      _1451: x0 => x0.from,
      _1452: x0 => x0.analyticsLabel,
      _1453: x0 => x0.link,
      ...
      _1457: () => globalThis.firebase_core.SDK_VERSION,
      _1463: x0 => x0.apiKey,
      _1465: x0 => x0.authDomain,
      _1467: x0 => x0.databaseURL,
      _1469: x0 => x0.projectId,
      _1471: x0 => x0.storageBucket,
      _1473: x0 => x0.messagingSenderId,
      _1475: x0 => x0.measurementId,
      _1477: x0 => x0.appId,
      _1479: x0 => x0.name,
      _1480: x0 => x0.options,
      _1481: (x0,x1) => x0.debug(x1),
      _1482: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1482(f,arguments.length,x0) }),
      _1483: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1483(f,arguments.length,x0,x1) }),
      _1484: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1485: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1486: (x0,x1) => x0.createScriptURL(x1),
      _1487: (x0,x1,x2) => x0.createScript(x1,x2),
      _1488: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1488(f,arguments.length,x0) }),
      _1490: x0 => x0.barcodeFormat,
      _1491: x0 => x0.text,
      _1492: x0 => x0.rawBytes,
      _1493: x0 => x0.resultPoints,
      _1495: Date.now,
      _1497: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1498: s => {
      ...
      _1500: () => typeof dartUseDateNowForTicks !== "undefined",
      _1501: () => 1000 * performance.now(),
      _1502: () => Date.now(),
      _1503: () => {
      ...
      _1505: () => new WeakMap(),
      _1506: (map, o) => map.get(o),
      _1507: (map, o, v) => map.set(o, v),
      _1508: x0 => new WeakRef(x0),
      _1509: x0 => x0.deref(),
      _1516: () => globalThis.WeakRef,
      _1520: s => JSON.stringify(s),
      _1521: s => printToConsole(s),
      _1522: (o, p, r) => o.replaceAll(p, () => r),
      _1523: (o, p, r) => o.replace(p, () => r),
      _1524: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1525: s => s.toUpperCase(),
      _1526: s => s.trim(),
      _1527: s => s.trimLeft(),
      _1528: s => s.trimRight(),
      _1529: (string, times) => string.repeat(times),
      _1530: Function.prototype.call.bind(String.prototype.indexOf),
      _1531: (s, p, i) => s.lastIndexOf(p, i),
      _1532: (string, token) => string.split(token),
      _1533: Object.is,
      _1534: o => o instanceof Array,
      _1535: (a, i) => a.push(i),
      _1536: (a, i) => a.splice(i, 1)[0],
      _1538: (a, l) => a.length = l,
      _1539: a => a.pop(),
      _1540: (a, i) => a.splice(i, 1),
      _1541: (a, s) => a.join(s),
      _1542: (a, s, e) => a.slice(s, e),
      _1544: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1545: a => a.length,
      _1547: (a, i) => a[i],
      _1548: (a, i, v) => a[i] = v,
      _1550: o => {
      ...
      _1573: (t, s) => t.set(s),
      _1574: l => new DataView(new ArrayBuffer(l)),
      _1575: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1576: o => o.byteLength,
      _1577: o => o.buffer,
      ...
      _1684: () => new XMLHttpRequest(),
      _1685: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1689: x0 => x0.send(),
      ...
      _1700: (x0,x1,x2,x3) => x0.slice(x1,x2,x3),
      ...
      _1710: x0 => x0.cancel(),
      _1711: x0 => x0.read(),
      _1712: x0 => x0.attachStreamToVideo,
      _1714: x0 => x0.decodeContinuously,
      _1718: x0 => x0.reset,
      _1720: x0 => x0.stopContinuousDecode,
      _1722: x0 => x0.stream,
      _1723: x0 => x0.videoElement,
      _1724: (x0,x1) => x0.key(x1),
      _1726: (x0,x1) => { x0.data = x1 },
      _1727: (x0,x1) => { x0.scale = x1 },
      _1728: (x0,x1) => { x0.canvasContext = x1 },
      _1729: (x0,x1) => { x0.viewport = x1 },
      _1730: (x0,x1) => { x0.cMapUrl = x1 },
      _1731: (x0,x1) => { x0.cMapPacked = x1 },
      _1732: x0 => x0.promise,
      _1733: x0 => x0.numPages,
      _1734: x0 => x0.width,
      _1735: x0 => x0.height,
      _1736: x0 => x0.promise,
      _1738: x0 => x0.facingMode,
      _1739: x0 => x0.getSettings(),
      _1740: (x0,x1) => ({width: x0,height: x1}),
      _1741: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      _1742: x0 => x0.trustedTypes,
      _1743: (x0,x1) => { x0.text = x1 },
      _1744: x0 => x0.random(),
      _1745: (x0,x1) => x0.getRandomValues(x1),
      _1746: () => globalThis.crypto,
      _1747: () => globalThis.Math,
      ...
      _1762: () => globalThis.document,
      _1768: (x0,x1) => { x0.height = x1 },
      _1770: (x0,x1) => { x0.width = x1 },
      _1779: x0 => x0.style,
      _1782: x0 => x0.src,
      _1783: (x0,x1) => { x0.src = x1 },
      _1784: x0 => x0.naturalWidth,
      _1785: x0 => x0.naturalHeight,
      _1801: x0 => x0.status,
      _1802: (x0,x1) => { x0.responseType = x1 },
      _1804: x0 => x0.response,
      _1805: x0 => x0.x,
      _1806: x0 => x0.y,
      _1855: (x0,x1) => { x0.responseType = x1 },
      _1856: x0 => x0.response,
      _1903: (x0,x1) => { x0.lang = x1 },
      _1916: (x0,x1) => { x0.draggable = x1 },
      _1932: x0 => x0.style,
      _1945: (x0,x1) => { x0.oncancel = x1 },
      _1951: (x0,x1) => { x0.onchange = x1 },
      _1991: (x0,x1) => { x0.onerror = x1 },
      _2007: (x0,x1) => { x0.onload = x1 },
      _2031: (x0,x1) => { x0.onpause = x1 },
      _2033: (x0,x1) => { x0.onplay = x1 },
      _2289: (x0,x1) => { x0.target = x1 },
      _2291: (x0,x1) => { x0.download = x1 },
      _2316: (x0,x1) => { x0.href = x1 },
      _2409: (x0,x1) => { x0.src = x1 },
      _2420: (x0,x1) => { x0.width = x1 },
      _2422: (x0,x1) => { x0.height = x1 },
      _2504: x0 => x0.videoWidth,
      _2505: x0 => x0.videoHeight,
      _2534: x0 => x0.error,
      _2535: x0 => x0.src,
      _2536: (x0,x1) => { x0.src = x1 },
      _2544: (x0,x1) => { x0.preload = x1 },
      _2545: x0 => x0.buffered,
      _2548: x0 => x0.currentTime,
      _2549: (x0,x1) => { x0.currentTime = x1 },
      _2550: x0 => x0.duration,
      _2551: x0 => x0.paused,
      _2555: (x0,x1) => { x0.playbackRate = x1 },
      _2566: (x0,x1) => { x0.controls = x1 },
      _2568: (x0,x1) => { x0.volume = x1 },
      _2585: x0 => x0.code,
      _2586: x0 => x0.message,
      _2660: x0 => x0.length,
      ...
      _3164: (x0,x1) => { x0.src = x1 },
      _3166: (x0,x1) => { x0.type = x1 },
      _3170: (x0,x1) => { x0.async = x1 },
      _3172: (x0,x1) => { x0.defer = x1 },
      _3174: (x0,x1) => { x0.crossOrigin = x1 },
      _3176: (x0,x1) => { x0.text = x1 },
      _3208: x0 => x0.width,
      ...
      _3956: x0 => x0.trustedTypes,
      _3957: x0 => x0.sessionStorage,
